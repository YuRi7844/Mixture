...
<form action="${initParam.rootPath }/createVideo.do" id="registForm" method="post">
	...
	<div class="form-group">
		<input type="hidden" id ="videoCategory" name="videoCategory" value="performance" class="form-control">
	</div>
	...
	<button type="button" class="btn btn-default"
		onclick="location.href='${initParam.rootPath}/videoListCategory.do?category=performance'">취소</button>
	</form> 
