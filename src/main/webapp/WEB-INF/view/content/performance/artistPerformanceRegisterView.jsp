...
<link rel="stylesheet" href="${initParam.rootPath }/resource/css/jquery.timepicker.min.css">
	...
	<div style="width: 100%;" class="center-block">
		<form action="${initParam.rootPath }/artist/performanceRegister.do" 
		method="post" class="performance_register_form center-block" 
		enctype="multipart/form-data" id="stageRegForm"
		style="width: 60%;">
			...
			<div class="form-group col-sm-6">
				<label class="col-sm-6">공연일시</label><input type="date" name="performanceDay" id="performanceDay" class="form-control" required="required">
			</div>
			<div class="form-group col-sm-6">
				<label class="col-sm-6">공연시간</label><input type="Timepicker" name="performanceTime" id="performanceTime" class="form-control" required="required" readonly="readonly" style="background-color: #fff;">
			</div>
			...
			<div class="form-group">
				<textarea rows="15" class="form-control col-sm-12" style="resize: none;" name="performanceContent" placeholder="공연에 대한 정보를 입력하세요."></textarea>
			</div>
