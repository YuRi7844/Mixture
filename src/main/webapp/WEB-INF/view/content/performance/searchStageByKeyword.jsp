...
function getListItem(index, places) {
    ...
    if (places.road_address_name) {
    	stageLocation = places.road_address_name;
        itemStr += '    <span>' + places.road_address_name + '</span>' +
                    '   <span class="jibun gray">' +  places.address_name  + '</span>';
    } else {
    	stageLocation = places.address_name;
        itemStr += '    <span>' +  places.address_name  + '</span>'; 
    }
                 
      itemStr += '  <span class="tel">' + places.phone  + '</span>' +
      			'<span><button id="confirm" type="button" value="" onclick="confirmStage()">선택</button></span>'+
                '</div>';           
...
function confirmStage(){
	if(stageLocation==null){
		...
		opener.document.getElementById("performanceLocation").value = stageLocation;
		window.close();
	}
}
</script>
