...
<div class="row">
	...
	<div class="col-sm-6">
		<form action="${initParam.rootPath }/admin/searchArtistPerformance.do" method="post">
			<sec:csrfInput />
		...
		<tbody>
			<c:forEach items="${requestScope.list }" var="performance">
				<tr>
					...
					<td>
						<form action="${initParam.rootPath }/admin/viewDetailArtistPerformance.do" method="post">
							<sec:csrfInput/>
					...
					<td>
						<form action="${initParam.rootPath }/admin/deleteArtistPerformance.do" method="post">
							<sec:csrfInput/>
							<input type="hidden" name="performanceNo" value="${performance.performanceNo }">
